...
void Torpedo::enable_motor_output()
{
    motors.output_min();
}

// motors_output - send output to motors library which will adjust and send to ESCs and servos
void Torpedo::motors_output()
{
...
bool Torpedo::verify_motor_test()
{
    bool pass = true;
...
bool Torpedo::handle_do_motor_test(mavlink_command_int_t command) {
...
void Torpedo::translate_wpnav_rp(float &lateral_out, float &forward_out)
{
...
// translate wpnav roll/pitch outputs to lateral/forward
void Torpedo::translate_circle_nav_rp(float &lateral_out, float &forward_out)
{
    // get roll and pitch targets in centidegrees
...
void Torpedo::translate_pos_control_rp(float &lateral_out, float &forward_out)
{
    // get roll and pitch targets in centidegrees
