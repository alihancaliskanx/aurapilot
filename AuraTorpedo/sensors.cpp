...
void Torpedo::read_rangefinder()
{
    ...
    if (rangefinder_state.alt_healthy) {
        ...
        rangefinder_state.rangefinder_terrain_offset_cm =
                torpedo.rangefinder_state.inertial_alt_cm - torpedo.rangefinder_state.alt_cm_filt.get();
    }
...
bool Torpedo::rangefinder_alt_ok() const
{
    uint32_t now = AP_HAL::millis();
