...
bool Torpedo::start_command(const AP_Mission::Mission_Command& cmd)
{
...
bool Torpedo::verify_command_callback(const AP_Mission::Mission_Command& cmd)
{
...
bool Torpedo::verify_command(const AP_Mission::Mission_Command& cmd)
{
    switch (cmd.id) {
        //
        // navigation commands
...
void Torpedo::do_nav_wp(const AP_Mission::Mission_Command& cmd)
{
...
void Torpedo::do_surface(const AP_Mission::Mission_Command& cmd)
{
...
void Torpedo::do_loiter_unlimited(const AP_Mission::Mission_Command& cmd)
{
...
void Torpedo::do_circle(const AP_Mission::Mission_Command& cmd)
{
...
// note: caller should set yaw_mode
void Torpedo::do_loiter_time(const AP_Mission::Mission_Command& cmd)
{
...
void Torpedo::do_nav_guided_enable(const AP_Mission::Mission_Command& cmd)
{
    if (cmd.p1 > 0) {
...
void Torpedo::do_nav_delay(const AP_Mission::Mission_Command& cmd)
{
...
void Torpedo::do_guided_limits(const AP_Mission::Mission_Command& cmd)
{
...
bool Torpedo::verify_nav_wp(const AP_Mission::Mission_Command& cmd)
{
...
bool Torpedo::verify_surface(const AP_Mission::Mission_Command& cmd)
{
    bool retval = false;
...
bool Torpedo::verify_RTL() {
    return wp_nav.reached_wp_destination();
}

bool Torpedo::verify_loiter_unlimited()
{
    return false;
}

// verify_loiter_time - check if we have loitered long enough
bool Torpedo::verify_loiter_time()
{
...
bool Torpedo::verify_circle(const AP_Mission::Mission_Command& cmd)
{
    ...
    return fabsf(torpedo.circle_nav.get_angle_total()/M_2PI) >= turns;
}

#if NAV_GUIDED == ENABLED
// verify_nav_guided - check if we have breached any limits
bool Torpedo::verify_nav_guided_enable(const AP_Mission::Mission_Command& cmd)
{
...
bool Torpedo::verify_nav_delay(const AP_Mission::Mission_Command& cmd)
{
...
void Torpedo::do_wait_delay(const AP_Mission::Mission_Command& cmd)
{
    condition_start = AP_HAL::millis();
    condition_value = cmd.content.delay.seconds * 1000;     // convert seconds to milliseconds
}

void Torpedo::do_within_distance(const AP_Mission::Mission_Command& cmd)
{
    condition_value  = cmd.content.distance.meters * 100;
}

void Torpedo::do_yaw(const AP_Mission::Mission_Command& cmd)
{
    torpedo.mode_auto.set_auto_yaw_look_at_heading(
...
bool Torpedo::verify_wait_delay()
{
...
bool Torpedo::verify_within_distance()
{
...
bool Torpedo::verify_yaw()
{
    // set yaw mode if it has been changed (the waypoint controller often retakes control of yaw as it executes a new waypoint command)
    if (auto_yaw_mode != AUTO_YAW_LOOK_AT_HEADING) {
        torpedo.mode_auto.set_auto_yaw_mode(AUTO_YAW_LOOK_AT_HEADING);
    }
...
bool Torpedo::do_guided(const AP_Mission::Mission_Command& cmd)
{
    ...
    case MAV_CMD_NAV_WAYPOINT: {
        ...
        return torpedo.mode_guided.guided_set_destination(cmd.content.location);
    }
...
void Torpedo::do_change_speed(const AP_Mission::Mission_Command& cmd)
{
...
void Torpedo::do_set_home(const AP_Mission::Mission_Command& cmd)
{
...
void Torpedo::do_roi(const AP_Mission::Mission_Command& cmd)
{
    torpedo.mode_auto.set_auto_yaw_roi(cmd.content.location);
}

// point the camera to a specified angle
void Torpedo::do_mount_control(const AP_Mission::Mission_Command& cmd)
{
