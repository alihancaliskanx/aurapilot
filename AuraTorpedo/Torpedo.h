...
#pragma once
/*
  This is the main Torpedo class
 */
...
class Torpedo : public AP_Vehicle {
public:
    friend class GCS_MAVLINK_Torpedo;
    friend class GCS_Torpedo;
    friend class Parameters;
    friend class ParametersG2;
    friend class AP_Arming_Torpedo;
...
private:
    ...
    // Mission library
    AP_Mission mission{
            FUNCTOR_BIND_MEMBER(&Torpedo::start_command, bool, const AP_Mission::Mission_Command &),
            FUNCTOR_BIND_MEMBER(&Torpedo::verify_command_callback, bool, const AP_Mission::Mission_Command &),
            FUNCTOR_BIND_MEMBER(&Torpedo::exit_mission, void)};
    ...
    // GCS selection
    GCS_Torpedo _gcs; // avoid using this; use gcs()
    GCS_Torpedo &gcs() { return _gcs; }
...
# include USERHOOK_VARIABLES
    ...
    AP_BattMonitor battery{MASK_LOG_CURRENT,
                           FUNCTOR_BIND_MEMBER(&Torpedo::handle_battery_failsafe, void, const char*, const int8_t),
                           _failsafe_priorities};

    AP_Arming_Torpedo arming;
    ...
    // 3D Location vectors
    // Current location of the Torpedo (altitude is relative to home)
...
public:
    ...
    static Torpedo *_singleton;

    static Torpedo *get_singleton() {
        return _singleton;
    }
