...
protected:
    ...
    // AURA torpido (Faz 3.2/3.3): pos_control z hedefi ile mevcut derinlikten
    // pitch talebi (cd) uretir — dikey itici yok, derinlik pitch'le tutulur.
    // Dusuk yol hizinda otorite lineer kisilir. ALT_HOLD ve AUTO paylasir.
    float trpd_derinlik_pitch_cd() const;
