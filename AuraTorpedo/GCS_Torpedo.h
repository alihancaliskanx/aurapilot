...
class GCS_Torpedo : public GCS
{
    friend class Torpedo; // for access to _chan in parameter declarations
...
public:
    ...
    GCS_MAVLINK_CHAN_METHOD_DEFINITIONS(GCS_MAVLINK_Torpedo);
...
protected:
    ...
    GCS_MAVLINK_Torpedo *new_gcs_mavlink_backend(GCS_MAVLINK_Parameters &params,
                                             AP_HAL::UARTDriver &uart) override {
        return new GCS_MAVLINK_Torpedo(params, uart);
    }
