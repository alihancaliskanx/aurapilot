...
void Torpedo::mainloop_failsafe_enable()
{
...
void Torpedo::mainloop_failsafe_disable()
{
...
void Torpedo::mainloop_failsafe_check()
{
...
void Torpedo::failsafe_sensors_check()
{
    ...
    if (control_mode == Mode::Number::ALT_HOLD || control_mode == Mode::Number::SURFACE || torpedo.flightmode->requires_GPS()) {
...
void Torpedo::failsafe_ekf_check()
{
...
void Torpedo::handle_battery_failsafe(const char* type_str, const int8_t action)
{
...
void Torpedo::failsafe_pilot_input_check()
{
...
void Torpedo::failsafe_internal_pressure_check()
{
...
void Torpedo::failsafe_internal_temperature_check()
{
...
void Torpedo::failsafe_leak_check()
{
...
void Torpedo::failsafe_gcs_check()
{
...
void Torpedo::failsafe_crash_check()
{
...
void Torpedo::failsafe_terrain_check()
{
...
void Torpedo::failsafe_terrain_set_status(bool data_ok)
{
...
void Torpedo::failsafe_terrain_on_event()
{
    ...
    if (!rangefinder_state.enabled || !torpedo.mode_auto.auto_terrain_recover_start()) {
...
void Torpedo::failsafe_terrain_act()
{
