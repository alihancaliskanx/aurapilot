...
void Torpedo::transform_manual_control_to_rc_override(int16_t x, int16_t y, int16_t z, int16_t r, uint16_t buttons, uint16_t buttons2, uint8_t enabled_extensions,
            int16_t s,
            int16_t t,
            int16_t aux1,
            int16_t aux2,
...
void Torpedo::handle_jsbutton_press(uint8_t _button, bool shift, bool held)
{
    ...
    case JSButton::button_function_t::k_script_1:
        torpedo.script_buttons[0].press();
        break;
    case JSButton::button_function_t::k_script_2:
        torpedo.script_buttons[1].press();
        break;
    case JSButton::button_function_t::k_script_3:
        torpedo.script_buttons[2].press();
        break;
    case JSButton::button_function_t::k_script_4:
        torpedo.script_buttons[3].press();
        break;
#endif // AP_SCRIPTING_ENABLED
    }
}

void Torpedo::handle_jsbutton_release(uint8_t _button, bool shift) {
...
#if AP_SCRIPTING_ENABLED
    case JSButton::button_function_t::k_script_1:
        torpedo.script_buttons[0].release();
        break;
    case JSButton::button_function_t::k_script_2:
        torpedo.script_buttons[1].release();
        break;
    case JSButton::button_function_t::k_script_3:
        torpedo.script_buttons[2].release();
        break;
    case JSButton::button_function_t::k_script_4:
        torpedo.script_buttons[3].release();
        break;
#endif // AP_SCRIPTING_ENABLED
    }
}

JSButton* Torpedo::get_button(uint8_t index)
{
...
void Torpedo::default_js_buttons()
{
...
void Torpedo::set_neutral_controls()
{
    uint32_t tnow = AP_HAL::millis();
...
#if AP_SCRIPTING_ENABLED
bool Torpedo::is_button_pressed(uint8_t index)
{
    return script_buttons[index - 1].is_pressed();
}

uint8_t Torpedo::get_and_clear_button_count(uint8_t index)
{
