...
void Torpedo::get_pilot_desired_lean_angles(float roll_in, float pitch_in, float &roll_out, float &pitch_out, float angle_max)
{
...
float Torpedo::get_pilot_desired_yaw_rate(int16_t stick_angle) const
{
...
void Torpedo::check_ekf_yaw_reset()
{
...
float Torpedo::get_look_ahead_yaw()
{
...
float Torpedo::get_pilot_desired_climb_rate(float throttle_control)
{
...
void Torpedo::rotate_body_frame_to_NE(float &x, float &y)
{
...
uint16_t Torpedo::get_pilot_speed_dn() const
{
