...
{
    torpedo.mainloop_failsafe_check();
}

void Torpedo::init_ardupilot()
{
    BoardConfig.init();
    ...
    // In order to preserve Torpedo's previous AP_TemperatureSensor Behavior we set the Default I2C Bus Here
...
#if HAL_LOGGING_ENABLED
    logger.setVehicle_Startup_Writer(FUNCTOR_BIND(&torpedo, &Torpedo::Log_Write_Vehicle_Startup_Messages, void));
#endif
...
//******************************************************************************
void Torpedo::startup_INS_ground()
{
...
bool Torpedo::optflow_position_ok()
{
 ...
 */
bool Torpedo::should_log(uint32_t mask)
{
