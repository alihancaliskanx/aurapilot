...
#define AP_PARAM_VEHICLE_NAME torpedo
...
public:
    ...
    AP_Float        surftrak_depth;             // surftrak will try to keep torpedo below this depth
#endif
...
// Torpedo-specific default parameters
