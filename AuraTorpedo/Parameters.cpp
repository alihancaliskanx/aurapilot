...
/*
 *  AuraTorpedo parameter definitions
 *
 */

const AP_Param::Info Torpedo::var_info[] = {
    ...
    // @User: Standard
    // @RebootRequired: True
    // @Values: 0:BlueROV1, 1:Vectored, 2:Vectored_6DOF, 3:Vectored_6DOF_90, 4:SimpleROV-3, 5:SimpleROV-4, 6:SimpleROV-5, 7:Custom, 8:Torpedo_XTail
    // AURA: AuraTorpedo'nun dogal frame'i X-kuyruk torpido (tek pervane + 4 fin)
    GSCALAR(frame_configuration, "FRAME_CONFIG", AP_Motors6DOF::SUB_FRAME_TORPEDO_XTAIL),
    ...
    // @Group: ARMING_
    // @Path: AP_Arming_Torpedo.cpp,../libraries/AP_Arming/AP_Arming.cpp
    GOBJECT(arming, "ARMING_", AP_Arming_Torpedo),
...
void Torpedo::convert_old_parameters()
{
