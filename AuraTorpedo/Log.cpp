...
void Torpedo::Log_Write_Control_Tuning()
{
...
void Torpedo::Log_Write_Attitude()
{
...
UNUSED_FUNCTION
void Torpedo::Log_Write_Data(LogDataID id, int16_t value)
{
...
UNUSED_FUNCTION
void Torpedo::Log_Write_Data(LogDataID id, uint16_t value)
{
    if (should_log(MASK_LOG_ANY)) {
...
void Torpedo::Log_Write_Data(LogDataID id, int32_t value)
{
    if (should_log(MASK_LOG_ANY)) {
...
void Torpedo::Log_Write_Data(LogDataID id, uint32_t value)
{
    if (should_log(MASK_LOG_ANY)) {
...
UNUSED_FUNCTION
void Torpedo::Log_Write_Data(LogDataID id, float value)
{
    if (should_log(MASK_LOG_ANY)) {
...
void Torpedo::Log_Write_GuidedTarget(uint8_t target_type, const Vector3f& pos_target, const Vector3f& vel_target)
{
...
const struct LogStructure Torpedo::log_structure[] = {
...
void Torpedo::Log_Write_Vehicle_Startup_Messages()
{
