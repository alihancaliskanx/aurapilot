...
enum autopilot_yaw_mode {
    ...
    AUTO_YAW_CORRECT_XTRACK =    6,  // steer the torpedo in order to correct for crosstrack error during line following
    AUTO_YAW_RATE =              7   // steer the torpedo with the desired yaw rate 
};
