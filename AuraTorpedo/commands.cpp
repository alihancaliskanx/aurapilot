...
void Torpedo::update_home_from_EKF()
{
...
void Torpedo::set_home_to_current_location_inflight()
{
...
bool Torpedo::set_home_to_current_location(bool lock)
{
    // get current location from EKF
    Location temp_loc;
...
bool Torpedo::set_home(const Location& loc, bool lock)
{
...
bool Torpedo::far_from_EKF_origin(const Location& loc)
{
